...
const bn: Dict = {
  ...
  water_purifier: "ওয়াটার পিউরিফায়ার",
  ceiling_fan: "সিলিং ফ্যান",
  induction_cooker: "ইনডাকশন কুকার",
  room_heater: "রুম হিটার",
  small_electronics: "ছোট হোম ইলেকট্রনিক্স",
  more_appliances: "আরও অ্যাপ্লায়েন্স",
  ...
  policy_body: "স্বচ্ছ মূল্য নির্ধারণ এবং প্রতিটি মেরামতে সৎ পরিদর্শন।",
  reviews_title: "গ্রাহকদের মতামত",
  location_title: "আমাদের খুঁজুন",
  location_body: "খোয়াই, ত্রিপুরা, ভারত থেকে — আমরা এলাকা জুড়ে অন-সাইট সার্ভিস প্রদান করি। WhatsApp ট্যাপ করে আপনার লোকেশন শেয়ার করুন।",
...
const hi: Dict = {
  ...
  water_purifier: "वाटर प्यूरिफायर",
  ceiling_fan: "सीलिंग फैन",
  induction_cooker: "इंडक्शन कुकर",
  room_heater: "रूम हीटर",
  small_electronics: "छोटे होम इलेक्ट्रॉनिक्स",
  more_appliances: "और उपकरण",
  ...
  policy_body: "पारदर्शी मूल्य निर्धारण और हर मरम्मत पर ईमानदार जाँच।",
  reviews_title: "ग्राहक क्या कहते हैं",
  location_title: "हमें खोजें",
  location_body: "खोवाई, त्रिपुरा, भारत से — हम पूरे क्षेत्र में ऑन-साइट सेवा देते हैं। WhatsApp टैप करके अपना स्थान साझा करें।",

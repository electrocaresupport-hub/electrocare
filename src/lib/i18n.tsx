...
const en: Dict = {
  ...
  policy_body: "Transparent pricing. No-fix, no-fee diagnostics on most appliances. 30-day service warranty on repaired parts.",
  reviews_title: "What Customers Say",
  location_title: "Find Us",
  location_body: "We provide on-site service across the city. Tap WhatsApp to share your location.",
